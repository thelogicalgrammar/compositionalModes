Snellius job scripts for the `quantifiers_composite` case study.

Before submitting, ensure Main.cpp has the `quantifiers_composite` case study
active (its config.h included before types.h, its hypothesis.h after agent.h).
...
Submit from this directory (case_studies/quantifiers_composite/server/snellius):
